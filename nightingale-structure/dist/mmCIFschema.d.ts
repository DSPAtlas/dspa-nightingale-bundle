 ...
 */
import { Database, Column } from 'molstar/lib/mol-data/db';
...
export declare const mmCIF_Schema: {
    ...
    software: {
         ...
         * common types.
         */
        type: Schema.Aliased<"other" | "program" | "library" | "package" | "filter" | "jiffy">;
        /**
    ...
    ihm_dataset_group: {
         ...
         */
        application: Schema.Aliased<"other" | "filter" | "validation" | "restraint" | "representation" | "sampling" | "modeling">;
        /**
    ...
    ihm_dataset_related_db_reference: {
         ...
         */
        db_name: Schema.Aliased<"BMRB" | "PDB" | "Other" | "PDB-Dev" | "EMDB" | "EMPIAR" | "SASBDB" | "PRIDE" | "MODEL ARCHIVE" | "MASSIVE" | "BioGRID" | "ProXL" | "jPOSTrepo" | "iProX" | "AlphaFoldDB" | "ProteomeXchange" | "BMRbig">;
        /**
...
//# sourceMappingURL=mmCIFschema.d.ts.map